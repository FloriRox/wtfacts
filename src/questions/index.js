...
const QUESTIONS_DE = {
  adult: {
    ...
    "🏛️ Politik & Macht":       { questions: adultPolitikDe,      locked: false },
...
const QUESTIONS_EN = {
  adult: {
    ...
    "🏛️ Politics & Power":      { questions: adultPolitikEn,      locked: false },
...
const QUESTIONS_ES = {
  adult: {
    ...
    "🏛️ Política y Poder":      { questions: adultPolitikEs,      locked: false },
